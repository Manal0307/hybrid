...
const BIOMATERIALS = [
  {
    id: "floral-bioplastic",
    name: "Floral bioplastic",
    short: "Used for the bag lining",
    family: "Gelatin-based",
    accent: "#e8a8c4",
    description:
      "A soft, translucent bioplastic embedded with dried flower petals and cauliflower fibers. Used as the inner lining of the Hybrid bag.",
    ingredients: [
      "12 g food gelatin (or 4 g agar)",
      "60 ml water",
      "8 g glycerin",
      "Dried flower petals + cauliflower fibers",
    ],
    steps: [
      ...
      "Pour onto a silicone mat, sprinkle petals and fibers evenly.",
  ...
  {
    id: "cauliflower-bio",
    name: "Cauliflower fiber",
    short: "From kitchen waste",
    family: "Vegetable-based",
    accent: "#e8e0c8",
    description:
      "Cauliflower stalks and leaves usually thrown away — turned into a soft, pale fibrous material. Used alongside the floral bioplastic in the Hybrid bag.",
    ingredients: [
      "300 g cauliflower stalks and leaves",
      "100 ml water",
      "10 g glycerin",
      "5 g agar-agar",
    ],
    steps: [
      "Steam the stalks until very soft.",
      "Blend with water into a smooth pulp.",
